...
struct NoteParams {
  ...
  double pathway_step_beats = 1.0;
  double pathway_rest_beats = 0.5;
  int pathway_tempo_bpm = 120;
...
struct ChordParams {
  ...
  int prompt_right_program = 0;
  int prompt_right_channel = 0;
  int prompt_bass_program = 0;
  int prompt_bass_channel = 1;
  int prompt_velocity = 96;
  int prompt_duration_ms = 1000;
  int prompt_strum_step_ms = 0;
